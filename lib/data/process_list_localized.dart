...
final Map<String, List<ProcessStudy>> processListLocalized = {
  ...
  'en': [
    ProcessStudy('Administrative Process', 'Administrative processes are essential for the effective management of any organization.', [
      ProcessStage('Planning', 'Set objectives and determine the necessary actions to achieve them.'),
      ProcessStage('Organizing', 'Assign resources, tasks, and responsibilities to achieve objectives.'),
      ProcessStage('Directing', 'Lead, motivate, and guide employees to meet established goals.'),
      ProcessStage('Controlling', 'Evaluate performance and take corrective actions if necessary to ensure objectives are met.'),
    ]),
    // ...otros procesos en inglés...
    ProcessStudy('5S', 'The 5S are a Japanese methodology focused on improving efficiency and quality in the workplace through organization and cleanliness.', [
      ProcessStage('Seiri (Sort)', 'Eliminate unnecessary items from the workspace, keeping only the essentials.'),
      ProcessStage('Seiton (Set in order)', 'Organize and label items so they are easy to find and use.'),
      ProcessStage('Seiso (Shine)', 'Keep the workplace clean and organized on a daily basis.'),
      ProcessStage('Seiketsu (Standardize)', 'Establish standards and procedures to maintain order and cleanliness.'),
      ProcessStage('Shitsuke (Sustain)', 'Foster self-discipline and commitment to the 5S practices to ensure their continuity.'),
    ]),
    ProcessStudy('Six Sigma (DMAIC)', 'Six Sigma is a management methodology that focuses on improving quality by identifying and eliminating defects in processes. It uses a data-driven approach and statistical tools to measure and analyze variability. The ultimate goal is to achieve a quality level where there are only 3.4 defects per million opportunities.', [
      ProcessStage('Define', 'Identify the problem or improvement opportunity.'),
      ProcessStage('Measure', 'Collect relevant data to understand the problem.'),
      ProcessStage('Analyze', 'Examine the data to identify root causes of the problem.'),
      ProcessStage('Improve', 'Develop and implement solutions to address root causes.'),
      ProcessStage('Control', 'Implement controls to ensure that improvements are maintained.'),
    ]),
    ProcessStudy('Selection Process', 'Recommended process for hiring new staff.', [
      ProcessStage('Needs Analysis', 'Needs analysis is the process organizations use to identify deficiencies or problems in an organization and point out the root cause.'),
      ProcessStage('Recruitment', 'Action and effect of recruiting.'),
      ProcessStage('Receiving Applications', 'Collecting information about the position, using techniques such as interviews and tests to evaluate candidates.'),
      ProcessStage('Preselection', 'Resumes are reviewed and the most suitable candidates are chosen to move on to the next stage, which usually includes interviews.'),
      ProcessStage('Testing', 'Technical evaluation of candidates.'),
      ProcessStage('Interview', 'Meeting, concurrence, and conference of two or more people in a specific place to discuss or resolve a matter.'),
      ProcessStage('Decision Evaluation', 'It consists of gathering information, evaluating alternatives, and then making the best possible final decision.'),
      ProcessStage('Hiring', 'Action and effect of hiring.'),
      ProcessStage('Onboarding', 'It is the action and effect of joining or adding something to another thing to form a whole.'),
      ProcessStage('Follow-up', 'Action and effect of following or being followed.'),
    ]),
    ProcessStudy('Brand', 'Process to evaluate the use and evaluation of the Brand.', [
      ProcessStage('Customer Service', 'It is a concept specific to the business world that encompasses the policies, actions, and provisions of a company regarding the treatment and contact with consumers before, during, and after a purchase or service contract.'),
      ProcessStage('Price', 'Price is the amount of money required to acquire a good or service.'),
      ProcessStage('Product Benefits', 'Product or service features that are perceived by the consumer as a differential advantage or current and real gain.'),
      ProcessStage('Website & Social Media', 'Refers to a set of digital platforms that allow interaction and communication between users.'),
      ProcessStage('Perception', 'Inner sensation resulting from a material impression produced in the bodily senses.'),
      ProcessStage('Packaging Design', 'Graphic design responsible for conceiving the shape and graphic design of a product\'s packaging.'),
      ProcessStage('Logo', 'Graphic symbol peculiar to a company, commemoration, brand, or product.'),
      ProcessStage('Colors, Type, and Labeling', 'It is a process that allows the identification of products and their recognition by consumers.'),
    ]),
    ProcessStudy('Maslow\'s Hierarchy of Needs', 'Also known as Maslow\'s Hierarchy of Needs, is a psychological theory that organizes human needs into levels, according to their importance and priority.', [
      ProcessStage('Physiological Needs', 'These are the most basic, such as water, food, sleep, and shelter.'),
      ProcessStage('Safety', 'Include physical, emotional, and financial security, as well as health and well-being.'),
      ProcessStage('Belongingness', 'Related to love, friendship, and a sense of belonging to a group.'),
      ProcessStage('Esteem', 'Refer to self-respect and respect from others, self-esteem, and recognition.'),
      ProcessStage('Self-actualization', 'It is the highest level, where personal development, creativity, and the fulfillment of personal goals are sought.'),
    ]),
    ProcessStudy('SWOT Analysis', 'It is a strategic tool used to evaluate the strengths, opportunities, weaknesses, and threats of an organization or project.', [
      ProcessStage('Strengths', 'Internal and positive characteristics that provide advantages over the competition, such as exclusive resources, strong capabilities, or a good reputation.'),
      ProcessStage('Opportunities', 'External factors that the organization can leverage to grow or improve, such as favorable market trends or changes in legislation.'),
      ProcessStage('Weaknesses', 'Internal aspects that limit performance or success, such as lack of resources, insufficient skills, or inefficient processes.'),
      ProcessStage('Threats', 'External factors that could cause problems or harm to the organization, such as intense competition, economic changes, or unfavorable regulations.'),
    ]),
    ProcessStudy('Business Plan', 'It is a written document that describes in detail how a company plans to achieve its objectives.', [
      ProcessStage('Executive Summary', 'It is a concise and clear document that summarizes the most important aspects of a report or project.'),
      ProcessStage('Mission', 'Power, faculty given to someone to go and perform a task.'),
      ProcessStage('Background', 'They are events, facts, or previous circumstances that are relevant to understanding a current situation or phenomenon. They are the historical basis that influences what is happening in the present.'),
      ProcessStage('Product Description', 'It is a brief written explanation of the features, benefits, and qualities of a product or service.'),
      ProcessStage('Marketing Plan', 'It is a strategic document that describes the necessary actions to achieve a company\'s marketing objectives.'),
      ProcessStage('Competitive Analysis', 'It is the process that a company implements to know how to act in the competitive environment. This process begins by recognizing its competitors to determine their main objectives, strategies, strengths, and weaknesses.'),
      ProcessStage('SWOT Analysis', '(also known as FODA or DAFO) It is a technique that allows identifying and studying the strengths, weaknesses, opportunities, and threats of a project, company, or individual.'),
      ProcessStage('Operations', 'It is a set of planned actions executed to achieve a specific result, which can range from daily tasks to complex technical or scientific procedures.'),
      ProcessStage('Financing Plan', 'It is a strategic document that describes in detail how a company plans to obtain and manage the necessary economic resources to carry out its operations, meet its obligations, and achieve its short, medium, and long-term goals.'),
      ProcessStage('Timeline', 'It is the chronological visual representation of the most important events of a topic, period, process, or company\'s life. It allows organizing information in a way that one can see the historical order in which key milestones occurred.'),
      ProcessStage('Business Model Canvas', 'It is a strategic business tool that allows building a competitive and innovative business model in a very visual way.'),
    ]),
    ProcessStudy('SMART', 'is a methodology used to define clear and achievable objectives. Each letter represents a criterion to evaluate objectives.', [
    ...
    ProcessStudy('MECE', 'is the acronym for "Mutually Exclusive, Collectively Exhaustive". It represents a methodology for organizing and classifying information. It was developed by McKinsey & Company, one of the most powerful consulting firms in the world. This tool has become a fundamental tool for solving business problems.', [
      ProcessStage('Mutually Exclusive', 'Each category is unique and does not overlap with others.'),
      ProcessStage('Collectively Exhaustive', 'Together, the categories cover all possibilities.'),
      ProcessStage('Define the scope', 'Before starting, it is crucial to clearly define the scope of the problem or information being addressed. This provides clear boundaries and helps avoid including irrelevant elements.'),
      ProcessStage('Identify mutually exclusive categories', 'Within the defined scope, identify categories that are mutually exclusive. Each element should belong to one and only one of these categories.'),
      ProcessStage('Verify exhaustiveness', 'Ensure that the identified categories encompass all relevant information. There should be no gaps in information coverage.'),
      ProcessStage('Refine and adjust', 'It may be necessary to iterate and refine the categories as you delve deeper into the information. This is a natural part of the process and ensures that the MECE structure is accurate and complete.'),
    ]),
  ],
};
